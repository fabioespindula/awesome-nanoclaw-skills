...
- Aliases: `board`, `feba-board`, `/febaboard`, `/board`, `/feba-board`, `/council`, `second opinion`, `help me decide`, `pressure-test`
...
- Aliases: `read`, `readthis`, `read-this`, `/read`, `/readthis`, `summarize this`, `read this`, `bare URLs`
...
- Aliases: `skills`, `skills list`, `help skills`, `catalog`
