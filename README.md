...
| [xray](skills/xray) | Visual explanations with complete mental maps and short/long depth modes. |
...
| [xray](skills/xray) | NanoClaw runtime with this skill installed. Browser, file, or PDF tools are useful only when the requested source requires them. |
